...
static void gemm_openacc_kernel(const float *a, const float *b, float *c, int n) {
    int i, j, k;
...
int main(int argc, char **argv) {
    ...
    for (rep = 0; rep < args.warmup; ++rep) {
        #pragma acc data copyin(a[0:args.n*args.n], b[0:args.n*args.n]) copyout(c[0:args.n*args.n])
        {
            gemm_openacc_kernel(a, b, c, args.n);
        }
    }
    ...
    for (rep = 0; rep < args.iters; ++rep) {
        ...
        #pragma acc enter data copyin(a[0:args.n*args.n], b[0:args.n*args.n], c[0:args.n*args.n])
        #pragma acc wait
        ...
        #pragma acc update self(c[0:args.n*args.n])
        #pragma acc wait
        double td1 = wall_seconds();
        #pragma acc exit data delete(a[0:args.n*args.n], b[0:args.n*args.n], c[0:args.n*args.n])
    ...
    print_csv_line("openacc", args.n, args.repeat_id, &m);
